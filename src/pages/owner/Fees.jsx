...
const Fees = () => {
    ...
    const fetchFees = async () => {
        try {
            const { data } = await axios.get("/api/business/fees");
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(
                "/api/business/fees/upload-proof",
                formData
            );
            if (data.success) {
    ...
    return (
        <div className="px-4 pt-10 md:px-10 w-full">
            <Title
                title="Platform Fees"
                subTitle="Your periodic commission to the platform. Pay via bank transfer to the platform's account and upload a screenshot."
            />
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                            ...
                            upload the screenshot. The admin will verify it.
                        </p>
                        <input
                            type="file"
                            accept="image/*"
